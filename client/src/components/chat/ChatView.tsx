    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 md:pl-14 border-b border-gray-800 flex items-center justify-center relative">
        ...
        <h1 className="text-xl font-semibold text-gray-200 text-center">
          {id ? selectedConversation?.Title || "Conversación" : "Nueva conversación"}
        </h1>
      </div>
      ...
      >
        {id ? (
          ...
          <div className="h-full flex flex-col items-center justify-center px-4 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-200 mb-4">Chat de IA local</h1>
            <p className="text-gray-400 max-w-md mb-8">
              Una interfaz sencilla para conversar y preguntar a tus modelos locales de Ollama. Selecciona un modelo e inicia una nueva conversación.
            </p>
            <div className="flex flex-col items-center">
              <p className="text-gray-500 text-sm mb-2">Características:</p>
              <ul className="text-gray-400 text-sm text-left">
                <li className="flex items-center mb-1">
                  <span className="mr-2 text-purple-500">•</span> Respuestas en tiempo real
                </li>
                <li className="flex items-center mb-1">
                  <span className="mr-2 text-purple-500">•</span> Visualización del proceso de pensamiento de la IA
                </li>
                <li className="flex items-center mb-1">
                  <span className="mr-2 text-purple-500">•</span> Historial de chat y gestión de conversaciones
                </li>
                <li className="flex items-center">
                  <span className="mr-2 text-purple-500">•</span> Compatibilidad con todas tus modelos de Ollama
                </li>
              </ul>
            </div>
          </div>
